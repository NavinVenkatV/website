  ...
  const data = [
    {
      ...
      content: (
        <div className="flex flex-col gap-[20px]" id="experience">
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">Software Developer @AgileSoftLabs</Cover>
            </div>
...
Next.js, React, and Node.js. Developing and maintaining scalable APIs while integrating third-party services to enhance application functionality. Collaborating with cross-functional teams to design and implement robust and user-friendly solutions.</h4>
          ...
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">Freelancing</Cover>
            </div>
          ...
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">Web Developer at Stumonk</Cover>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-[20px]">
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">Puducherry Technological University</Cover>
            </div>
          ...
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">AHSS (Py)</Cover>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-[20px]">
          <div>
            <div>
              <Cover className="text-xl font-bold p-2">Keyboardist</Cover>
            </div>
